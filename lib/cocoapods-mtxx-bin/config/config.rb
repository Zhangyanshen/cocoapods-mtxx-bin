    ...
    def template_hash
      {
          ...
          'code_repo_url' => { description: '源码私有源 Git 地址', default: 'git@github.com:Zhangyanshen/example-private-spec-source.git' },
          'binary_repo_url' => { description: '二进制私有源 Git 地址', default: 'git@github.com:Zhangyanshen/example-private-spec-bin.git' },
